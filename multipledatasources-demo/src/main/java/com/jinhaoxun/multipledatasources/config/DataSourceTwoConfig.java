 ...
 */
@Configuration
@MapperScan(basePackages = "com.jinhaoxun.multipledatasources.mapper.db2",sqlSessionTemplateRef ="twoSqlSessionTemplate")
public class DataSourceTwoConfig {
    ...
    public SqlSessionFactory twoSqlSessionFactory(@Qualifier("twoDS") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(resolver.getResources("classpath*:com/jinhaoxun/multipledatasources/mapper/db2/xml/*.xml"));
