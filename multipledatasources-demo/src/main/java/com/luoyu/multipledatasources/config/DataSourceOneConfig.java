 ...
 */
@Configuration
@MapperScan(basePackages = {"com.luoyu.multipledatasources.mapper.db1"}, sqlSessionTemplateRef ="oneSqlSessionTemplate")
public class DataSourceOneConfig {
    ...
    public SqlSessionFactory oneSqlSessionFactory(@Qualifier("oneDS") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(resolver.getResources("classpath*:com/luoyu/multipledatasources/mapper/db1/xml/*.xml"));
